...
module.exports = function (model, permission) {
    ...
    router.get("/", allow(permission, 1), (req, res) => {
        service
            .getRecords({})
            .then((records) => {
                res.json(records);
    ...
    router.post("/search", allow(permission, 1), (req, res) => {
        service
            .getRecords(req.body)
            .then((records) => {
                res.json(records);
    ...
    router.get("/description", allow(permission, 1), (req, res) => {
        service
            .describe()
            .then((record) => {
                res.json(record);
    ...
    router.get("/:id", allow(permission, 1), (req, res) => {
        const { id } = req.params;
        service
            .getRecord({ _id: id })
            .then((record) => {
